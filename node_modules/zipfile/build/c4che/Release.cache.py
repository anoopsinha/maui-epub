...
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-I../deps/libzip-0.10/lib']
CXXFLAGS_DEBUG = ['-g']
...
LIBDIR = '/Users/anoopsinha/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['../deps/libzip-0.10/lib/.libs/libzip.a', '-Wl,-search_paths_first', '-lz']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/anoopsinha/.node_libraries'
PREFIX = '/usr/local'
